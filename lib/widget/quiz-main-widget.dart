      ...
      return Dialog(
        ...
        child: Container(
          decoration: BoxDecoration(
            borderRadius: BorderRadius.circular(12),
            gradient: const LinearGradient(
              colors: [Color(0xdaa8e6cf), Color(0xffc86b67)], // Main colors as per your specification
                      ...
                      child: Row(
                        ...
                        children: [
                          Padding(
                            ...
                            child :  category.name == "여행" ?  Icon(Icons.flight_rounded, size : 25, color: mode == "일반 모드" ?Colors.teal : Colors.redAccent,) :
                            category.name == "일상생활" ?  Icon(Icons.home_rounded, size : 25, color: mode == "일반 모드" ?Colors.teal : Colors.redAccent,) :
                            category.name == "식당" ?  Icon(Icons.restaurant_rounded, size : 25, color : mode == "일반 모드" ?Colors.teal : Colors.redAccent) : null,
                          ),
